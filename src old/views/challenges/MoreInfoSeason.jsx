                ...
                <div className="flex flex-col mt-8">
                    ...
                    {recipe.status === "ongoing" && (
                        <button
                            ...
                            className="self-start inline-flex items-end justify-center px-8 py-3 bg-dishyColor text-white font-semibold rounded-md transition duration-300 ease-in-out hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                        >
                            Register
                        </button>
                    )}
